    ...
    function canvas_init(index, hsb, hex, rgb) {
        ...
        for (var i = c.length - 1; i >= 0; i--) {
            if (index == 2 || index == 3) {
                ...
                c[i].style.height = breadcrumbs_parent_height + 'px';
                //actual height of canvas
                c[i].style.width = window.innerWidth + 'px';
        ...
        ; for (var i = h_c.length - 1; i >= 0; i--) {
            if (index == 1) {
                ...
                h_c[i].style.height = 10 + 'px';
                //actual height of canvas
                h_c[i].style.width = window.innerWidth + 'px';
                //actual width of canvas
        ...
        for (var i = f_h_c.length - 1; i >= 0; i--) {
            if (index == 1) {
                ...
                f_h_c[i].style.height = 10 + 'px';
                //actual height of canvas
                f_h_c[i].style.width = window.innerWidth + 'px';
                //actual width of canvas
        ...
        for (var i = t_h_c.length - 1; i >= 0; i--) {
            ...
            t_h_c[i].style.height = 10 + 'px';
            //actual height of canvas
            t_h_c[i].style.width = window.innerWidth + 'px';
            //actual width of canvas
        ...
        for (var i = br.length - 1; i >= 0; i--) {
            ...
            br[i].style.height = 22 + 'px';
            //actual height of canvas
            br[i].style.width = window.innerWidth + 'px';
            //actual width of canvas
        ...
        ; if (cloud.length && (index == 3)) {
            ...
            cloud[0].style.width = window.innerWidth + 'px';
            //actual width of canvas
            cloud[0].style.height = (patternParentHeight + 170) + 'px';
            //actual height of canvas
        ...
        ; if (w_cloud.length) {
            ...
            w_cloud[0].style.width = window.innerWidth + 'px';
            //actual width of canvas
            w_cloud[0].style.height = 50 + 'px';
            //actual height of canvas
