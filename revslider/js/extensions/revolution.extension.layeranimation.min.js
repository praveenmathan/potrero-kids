    ...
    var callCaptionLoops = function (el, factor) {
        ...
        if (el.hasClass("rs-pendulum")) {
            if (el.data('loop-timeline') == undefined) {
                ...
                el.data('loop-timeline').append(new punchgs.TweenLite.fromTo(el, speed, { force3D: "auto", rotation: enddeg, transformOrigin: origin }, {
        ...
        if (el.hasClass("rs-rotate")) {
            if (el.data('loop-timeline') == undefined) {
                ...
                el.data('loop-timeline').append(new punchgs.TweenLite.fromTo(el, speed, { force3D: "auto", rotation: startdeg, transformOrigin: origin }, {
        ...
        if (el.hasClass("rs-slideloop")) {
            if (el.data('loop-timeline') == undefined) {
                ...
                el.data('loop-timeline').append(new punchgs.TweenLite.fromTo(el, speed, { force3D: "auto", x: xe, y: ye }, {
        ...
        if (el.hasClass("rs-pulse")) {
            if (el.data('loop-timeline') == undefined) {
                ...
                el.data('loop-timeline').append(new punchgs.TweenLite.fromTo(el, speed, { force3D: "auto", scale: zoomend }, {
